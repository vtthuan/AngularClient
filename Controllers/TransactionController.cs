...
namespace AngularClient.Controllers
{
    ...
    public class TransactionController : Controller
    {
        ...
        [HttpPost]
        public StepTransactionViewModel Get(VideoViewModel videoPost)
        {
            // var video = _unitOfWork.VideoRepository.Get(videoPost.Id);
            ...
            //         break;
            // }
            return Mapper.Map<PreviewStepTransactionViewModel>(new Transaction("1", new Video()));;
        }
    }
}