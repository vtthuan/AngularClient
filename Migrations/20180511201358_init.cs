    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MediaProvider", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MediaProvider_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Videos_MediaProvider_MediaInfoId",
                        column: x => x.MediaInfoId,
                        principalTable: "MediaProvider",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhraseLearning = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PhraseNative = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    VideoId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Remarques", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Remarques_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Remarques_Videos_VideoId",
                        column: x => x.VideoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MediaProvider_UserId",
                table: "MediaProvider",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Remarques_UserId",
                table: "Remarques",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Remarques_VideoId",
                table: "Remarques",
                column: "VideoId");
